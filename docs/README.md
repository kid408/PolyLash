...
### 📚 核心文档
- **[当前系统详细说明（2026-03-09）](当前系统详细说明_2026-03-09.md)** - 当前代码实现的完整系统说明（推荐最新优先阅读）
- **[技能差异化改造目标与原则（2026-03-09）](技能差异化改造目标与原则_2026-03-09.md)** - 本轮技能改造的唯一目标与验收标准
- **[Q技能原型库（旧技能风格复兴，2026-03-09）](Q技能原型库_旧技能风格复兴_2026-03-09.md)** - 以老手感为核心的Q原型方案集
- **[E/F技能差异化与组合套路（2026-03-09）](EF技能差异化与组合套路_2026-03-09.md)** - E/F定位与角色联动套路
- **[技能差异化讨论与开发执行模板（2026-03-09）](技能差异化讨论与开发执行模板_2026-03-09.md)** - 讨论会与开发落地模板
- **[批次A技能实现规格（旧风格差异化，2026-03-09）](批次A技能实现规格_旧风格差异化_2026-03-09.md)** - 可直接拆任务的技能开发规格
- **[批次A技能参数建议表（2026-03-09）](批次A技能参数建议表_2026-03-09.md)** - 批次A首版参数基线
