...
Add-Check -Checks ([ref]$checks) -Id "shop_interval" -Description "shop interval is every wave" -Passed (Test-Contains -Path "scenes/arena/services/shop_flow_service.gd" -Pattern "const SHOP_INTERVAL_WAVES: int = 1") -Details "scenes/arena/services/shop_flow_service.gd"
