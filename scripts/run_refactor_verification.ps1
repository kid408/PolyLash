...
Add-Check -Checks ([ref]$checks) -Id "bond_v3_file" -Description "bond v3 config exists" -Passed (Test-Path "config/player/bond_config_v3.csv") -Details "config/player/bond_config_v3.csv"
...
Add-Check -Checks ([ref]$checks) -Id "enemy_v2_configs" -Description "enemy and wave v2 configs exist" -Passed ((Test-Path "config/enemy/enemy_config_v2.csv") -and (Test-Path "config/wave/wave_config_v2.csv") -and (Test-Path "config/wave/wave_units_config_v2.csv")) -Details "config/enemy|wave/*_v2.csv"
