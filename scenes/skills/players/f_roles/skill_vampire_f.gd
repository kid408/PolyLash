...
const ROLE_ID: String = "vampire"
const VAMPIRE_E_META_CENTER: String = "vampire_e_rite_center"
const VAMPIRE_E_META_RADIUS: String = "vampire_e_rite_radius"
const VAMPIRE_E_META_EXPIRE_MSEC: String = "vampire_e_rite_expire_msec"
const VAMPIRE_E_META_INTENSITY: String = "vampire_e_rite_intensity"
