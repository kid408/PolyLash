...
const TESLA_META_CENTER: String = "arcstriker_field_center"
const TESLA_META_RADIUS: String = "arcstriker_field_radius"
const TESLA_META_EXPIRE_MSEC: String = "arcstriker_field_expire_msec"
...
func _spawn_area_effect(polygon: PackedVector2Array) -> void:
	...
	_cache_arcstriker_field(polygon, field_duration)
...
func _cache_arcstriker_field(polygon: PackedVector2Array, duration: float) -> void:
