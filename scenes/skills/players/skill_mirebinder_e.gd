...
func execute() -> void:
	...
	var window_data: Array = _get_mirebinder_window(center, final_radius)
...
func _get_mirebinder_window(default_center: Vector2, default_radius: float) -> Array:
