extends PlayerBase
class_name PlayerInformationSupport
...
func _ready() -> void:
	...
	skill_manager.load_skills_from_config("information_Support")
...
#     print("[PlayerInformationSupport] 触发特殊事件")
