extends PlayerBase
class_name PlayerTechnologyHurricane
...
func _ready() -> void:
	...
	skill_manager.load_skills_from_config("technology_hurricane")
...
#     print("[PlayerTechnologyHurricane] 触发特殊事件")
